package com.efeichong.jpa.annotation;

import com.efeichong.jpa.FastJpaRepositoryImpl;
import com.efeichong.jpa.FastJpaRepositoriesRegistrar;
 ...
 * @author lxk
 * @date 2022/7/15
 * @description 开启fast-jpa支持,配置扫描dao(repositories)所在目录
 */
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Inherited
@Import(FastJpaRepositoriesRegistrar.class)
@EnableJpaAuditing
public @interface EnableFastJpa {

    /**
     * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation declarations e.g.:
     * {@code @EnableFastJpa("org.my.pkg")} instead of {@code @EnableFastJpa(basePackages="org.my.pkg")}.
     */
     ...
     * @since 1.9
     */
    Class<?> repositoryBaseClass() default FastJpaRepositoryImpl.class;
